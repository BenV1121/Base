...
public:
	...
	public:
		...
		T *operator& () { return &m_ref->m_data[m_idx].data; }  // get address of pointed to data
		...
		const T *operator& () const { return &m_ref->m_data[m_idx].data; } // get address of pointed to data (constant)
		...
		// progress the iterator and delete the current.
